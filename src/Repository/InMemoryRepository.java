...
/**
 * The InMemoryRepository class provides an in-memory implementation of the {@link Repository.IRepository} interface.
 ...
 */
public class InMemoryRepository <T extends HasID> implements Repository.IRepository<T> {
    ...
    public void create(T obj) {
        map.putIfAbsent(obj.getName(), obj);
    }
     ...
     *
     * @param name The ID of the object to delete.
     */
    @Override
